...
class SkeletonView extends StatelessWidget {
  const SkeletonView({super.key, this.child, this.skeletonBody, this.darkShadeColor ,this.radius, this.isLoading, this.borderRadius});
  final Widget? child;
  final Widget? skeletonBody;
  final double? radius;
  final bool? isLoading;
  final bool? darkShadeColor;
...
class Skeleton extends StatefulWidget {
  ...
  final bool? darkShadeColor;
  final BorderRadiusGeometry? borderRadius;
  const Skeleton({Key? key, this.child, this.isLoading,this.darkShadeColor, this.radius, this.borderRadius, this.skeletonBody}) : super(key: key);
      ...
      return Container(
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
            ...
            colors: widget.darkShadeColor == false || widget.darkShadeColor == null ?  [
